...
This NTPsec version also has support for the proposed NTS pool KE extensions,
which are described by
link:https://datatracker.ietf.org/doc/draft-venhoek-nts-pool/[
draft-venhoek-nts-pool-04: NTS extensions for enabling pools ]
